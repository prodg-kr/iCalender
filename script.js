document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2026년 개정 반영:
    // - 제헌절(7/17) 공휴일 재지정 (법률 제21338호, 2026.5.11 시행) + 대체공휴일 적용
    // - 노동절(5/1) 법정공휴일 지정 (법률 제21543호, 2026.5.1 시행) + 대체공휴일 적용
    //   ※ 2024·2025년은 법 시행 전이므로 기존 명칭 '근로자의 날' 유지
    const HOLIDAYS = {
        // ─── 2024 (잔여) ───
        ...
        '2026-03-01': '삼일절', '2026-03-02': '대체공휴일(삼일절)', '2026-05-01': '노동절',
        '2026-05-05': '어린이날', '2026-05-24': '부처님 오신 날', '2026-05-25': '대체공휴일(부처님 오신 날)',
        '2026-06-03': '제9회 전국동시지방선거', '2026-06-06': '현충일', '2026-07-17': '제헌절',
        '2026-08-15': '광복절', '2026-08-17': '대체공휴일(광복절)', '2026-09-24': '추석 연휴',
        '2026-09-25': '추석', '2026-09-26': '추석 연휴',
        // ※ 2026 추석(목·금·토)은 일요일과 겹치지 않아 대체공휴일 없음
        //    설날·추석 연휴는 '일요일'과 겹칠 때만 대체공휴일 적용 (토요일은 미적용)
        '2026-10-03': '개천절', '2026-10-05': '대체공휴일(개천절)', '2026-10-09': '한글날',
        '2026-12-25': '성탄절',
        // ─── 2027 ───
        '2027-01-01': '신정', '2027-02-06': '설날 연휴', '2027-02-07': '설날', '2027-02-08': '설날 연휴',
        '2027-02-09': '대체공휴일(설날)', '2027-03-01': '삼일절', '2027-05-01': '노동절',
        '2027-05-03': '대체공휴일(노동절)', '2027-05-05': '어린이날', '2027-05-13': '부처님 오신 날',
        '2027-06-06': '현충일', '2027-07-17': '제헌절', '2027-07-19': '대체공휴일(제헌절)',
        ...
        '2028-03-01': '삼일절', '2028-05-01': '노동절',
        '2028-05-02': '부처님 오신 날', '2028-05-05': '어린이날',
        '2028-06-06': '현충일', '2028-07-17': '제헌절', '2028-08-15': '광복절',
        '2028-10-02': '추석 연휴', '2028-10-03': '추석/개천절', '2028-10-04': '추석 연휴',
        '2028-10-05': '대체공휴일(개천절)', '2028-10-09': '한글날', '2028-12-25': '성탄절',
        // ─── 2029 ───
        '2029-01-01': '신정', '2029-02-12': '설날 연휴', '2029-02-13': '설날', '2029-02-14': '설날 연휴',
        '2029-03-01': '삼일절', '2029-05-01': '노동절',
        '2029-05-05': '어린이날', '2029-05-07': '대체공휴일(어린이날)',
        '2029-05-20': '부처님 오신 날', '2029-05-21': '대체공휴일(부처님 오신 날)',
        '2029-06-06': '현충일', '2029-07-17': '제헌절', '2029-08-15': '광복절',
        '2029-09-21': '추석 연휴', '2029-09-22': '추석', '2029-09-23': '추석 연휴',
        '2029-09-24': '대체공휴일(추석)', '2029-10-03': '개천절', '2029-10-09': '한글날',
        '2029-12-25': '성탄절',
        // ─── 2030 ───
        '2030-01-01': '신정', '2030-02-02': '설날 연휴', '2030-02-03': '설날', '2030-02-04': '설날 연휴',
        '2030-02-05': '대체공휴일(설날)', '2030-03-01': '삼일절', '2030-05-01': '노동절',
        '2030-05-05': '어린이날', '2030-05-06': '대체공휴일(어린이날)',
        '2030-05-09': '부처님 오신 날',
        '2030-06-06': '현충일', '2030-07-17': '제헌절', '2030-08-15': '광복절',
        '2030-09-11': '추석 연휴', '2030-09-12': '추석', '2030-09-13': '추석 연휴',
        '2030-10-03': '개천절', '2030-10-09': '한글날', '2030-12-25': '성탄절',
        // ─── 2031 ───
        '2031-01-01': '신정', '2031-01-22': '설날 연휴', '2031-01-23': '설날', '2031-01-24': '설날 연휴',
        '2031-03-01': '삼일절', '2031-03-03': '대체공휴일(삼일절)',
        '2031-05-01': '노동절', '2031-05-05': '어린이날',
        '2031-05-28': '부처님 오신 날',
        '2031-06-06': '현충일', '2031-07-17': '제헌절', '2031-08-15': '광복절',
        '2031-09-30': '추석 연휴', '2031-10-01': '추석', '2031-10-02': '추석 연휴',
        '2031-10-03': '개천절', '2031-10-09': '한글날', '2031-12-25': '성탄절',
        // ─── 2032 ───
        '2032-01-01': '신정', '2032-02-10': '설날 연휴', '2032-02-11': '설날', '2032-02-12': '설날 연휴',
        '2032-03-01': '삼일절', '2032-05-01': '노동절', '2032-05-03': '대체공휴일(노동절)',
        '2032-05-05': '어린이날', '2032-05-16': '부처님 오신 날', '2032-05-17': '대체공휴일(부처님 오신 날)',
        '2032-06-06': '현충일', '2032-07-17': '제헌절', '2032-07-19': '대체공휴일(제헌절)',
        '2032-08-15': '광복절', '2032-08-16': '대체공휴일(광복절)',
        ...
        '2033-02-02': '대체공휴일', '2033-03-01': '삼일절', '2033-05-01': '노동절',
        '2033-05-02': '대체공휴일(노동절)', '2033-05-05': '어린이날', '2033-05-06': '부처님 오신 날',
        '2033-06-06': '현충일', '2033-07-17': '제헌절', '2033-07-18': '대체공휴일(제헌절)',
        '2033-08-15': '광복절'
    };
    ...
    // 연차 계단 (2026.8.25 실제 부여 16개 기준 — 근로기준법 2년 주기)
    // 2025: 15 / 2026·2027: 16 / 2028·2029: 17 / 2030·2031: 18 / 2032: 19 / 2033: 퇴임
    function getLeaveState(targetDate = currentDate) {
        const pYear = getLeavePeriod(targetDate);
        let total = 15;
        if (pYear >= 2033) total = 0; // 정년퇴임
        else if (pYear >= 2032) total = 19;
        else if (pYear >= 2030) total = 18;
        else if (pYear >= 2028) total = 17;
        else if (pYear >= 2026) total = 16;
    ...
    function isWorkDay(date) {
        ...
        if (HOLIDAYS[dateStr]) return false;   // 공휴일
        return true;
    }
            ...
            return `
                    <div class="golden-card ${w.badgeClass}" data-window="${i}">
                        ...
                        <div class="golden-stats">
                            ...
                            <div class="stat"><span class="stat-num text-green">${w.extDays}</span><span class="stat-label">조퇴+지각 시</span></div>
                        </div>
    ...
    function renderAiPanel() {
        ...
        `;
        // innerHTML 세팅 직후 welcomeMsg 표시 (ID 생성 후 호출해야 null 에러 없음)
        window.showWelcome();
    }
    ...
    const TIPS = {
        ...
        earlyBook: {
            ...
            content: `
                ...
                <strong>✅ 결론: 다음 황금연휴 항공권</strong><br>
                일정 확정 즉시 검색 시작 → <strong>출발 3~5개월 전 예약 완료</strong>가 최적!`
        }
    };
    ...
    function createDayCell(date, isOtherMonth, isToday = false) {
        ...
        const dateStr = formatDateLocal(date), holidayName = HOLIDAYS[dateStr], day = date.getDay();
        ...
        const makeCard = (trip, isPast) => {
            ...
            item.innerHTML = `
                <div class="card-info">
                    ...
                    <span class="dday" style="color:${color}">${dLabel}</span>
                </div>
                <div class="card-meta">
                    <span>${formatDateKR(trip.start)} ~ ${formatDateKR(trip.end)}</span>
